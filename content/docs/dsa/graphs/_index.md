...
- **Classical Problems**
  - Topological Sort [](/docs/dsa/graphs/topological-sort/)
  - Cycle Detection
  - Eulerian/Path Circuit [](/docs/dsa/graphs/eulerian-path/)
  - Hamiltonian Path/Circuit [](/docs/dsa/graphs/hamiltonian-path/)
- **Shortest Path**
  - Dijkstra [](/docs/dsa/graphs/shortest-path/dijkstra/)
  - Bellman-Ford [](/docs/dsa/graphs/shortest-path/bellman-ford/)
  - Floyd-Warshall [](/docs/dsa/graphs/shortest-path/floyd-warshall/)
- **Minimum Spanning Tree**
  - Kruskal [](/docs/dsa/graphs/mst/kruskal/)
  - Prim [](/docs/dsa/graphs/mst/prim/)
- **Advanced Graph**
  - Kosaraju (SCC) [](/docs/dsa/graphs/kosaraju/)
- **Tree Algorithms**
  - Lowest Common Ancestor (LCA) [](/docs/dsa/graphs/tree/lca/)
  - Tree Diameter [](/docs/dsa/graphs/tree/tree-diameter/)
  - Centroid Decomposition [](/docs/dsa/graphs/tree/centroid-decomp/)
  - Heavy-Light Decomposition [](/docs/dsa/graphs/tree/heavy-light-decomp/)
  - Persistent Segment Tree [](/docs/dsa/graphs/tree/persistent-segment-tree/)
- **Union-Find/DSU**
  - Basic Operations [](/docs/dsa/graphs/disjoint-set-union/)
  - Tarjan's Algorithm (Applications) [](/docs/dsa/graphs/dsu/tarjan-algorithm/)
```
