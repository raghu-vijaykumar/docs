...
aliases: ["/docs/dsa/data-structures/cache/"]
---
...
interface Cache<K, V> {
    ...
    void remove(K key, V value); // Remove specific key
...
See dedicated pages:
- LRU Cache: {{< relref "docs/dsa/caching/lru" >}}
- LFU Cache: {{< relref "docs/dsa/caching/lfu" >}}
