...
# Tree Data Structures
- **Basic Trees**
  - Binary Tree [](/docs/dsa/trees/binarytree/)
  - Binary Search Tree (BST)
- **Balanced Trees**
  - AVL Tree [](/docs/dsa/trees/avl-trees/)
  - Red-Black Tree [](/docs/dsa/trees/rb-tree/)
  - B-Tree [](/docs/dsa/trees/b-trees/)
- **Specialized Trees**
  - Segment Tree [](/docs/dsa/trees/segment-tree/)
  - Fenwick Tree [](/docs/dsa/trees/fenwick-tree/)
  - KD-Tree [](/docs/dsa/trees/kd-trees/)
  - Suffix Tree [](/docs/dsa/trees/suffix-trees/)
- **Tree Operations**
